...
-   As a first author, I pledge to submit my research to journals that are free to read, free to publish, and have an open license (e.g., CC-BY), that is, Diamond Open Access journals. I rarely agree to do reviews for non diamond OA journals and if so, I recommend that the editors to flip the journal or post them [online](https://osf.io/pbnw7/). If a commercial journal invites me to review, I prefer to review the preprint. Please note that some journals' reviewer invitations ask the invitees to treat them confidentially. In all other situations, I endorse Open Access with the a ranking of Diamond \> Green \> Gold. I believe that every researchers needs to know that the current publication system is a [big](https://treemaps.openapc.net/apcdata/openapc/publisher#/period=) [waste of (mostly tax) money](https://royalsocietypublishing.org/doi/10.1098/rsos.230206).

-   I endorse the [Free Journal Network](https://freejournals.org), the [OA finder](https://finder.open-access.network), [MetaResearch Open Review](https://cms.metaror.org) and [Peer Community in](https://peercommunityin.org/current-pcis/).
