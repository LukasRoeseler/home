...
-   Hartmann, H., Azevedo, F., **Röseler, L.**, Wallrich, L., Aldoh, A., Elsherif, M. M., … Leech, G. (2025, December 3). Tracking and mainstreaming replications in the social, cognitive, and behavioral sciences. https://doi.org/10.31222/osf.io/ad2w6_v2
...
+==============================================================+====================+=====================+========================================+==========================================================================+==========+
| Moderators of Anchoring Effects                              | 2022               | First author        | DFG, Sachbeihilfe                      | [https://osf.io/x6bqh](https://osf.io/x6bqh/){.uri}                      | rejected |
+--------------------------------------------------------------+--------------------+---------------------+----------------------------------------+--------------------------------------------------------------------------+----------+
| Formation of a Replication Journal                           | 2024               | First author        | Topical Program, University of Münster | [https://osf.io/9vgx7](https://osf.io/9vgx7/){.uri}                      | accepted |
+--------------------------------------------------------------+--------------------+---------------------+----------------------------------------+--------------------------------------------------------------------------+----------+
...
+--------------------------------------------------------------+--------------------+---------------------+----------------------------------------+--------------------------------------------------------------------------+----------+
| Expanding the Replication Database                           | 2023               | First author        | Ideenlabor, University of Münster      | [https://osf.io/854vt](https://osf.io/854vt/){.uri}                      | rejected |
+--------------------------------------------------------------+--------------------+---------------------+----------------------------------------+--------------------------------------------------------------------------+----------+
...
-   **Röseler, L.** (2026, March 4). Replication Journal Showcase: Replication Research (R2). Love Replications Week (LRW). Zenodo. <https://doi.org/10.5281/zenodo.18864153>

-   **Röseler, L.** (2026, March 4). Getting your replication report ready for submission. Love Replications Week (LRW), Online. Zenodo. <https://doi.org/10.5281/zenodo.18757230>
...
-   **Röseler, L.** (2026, March). Love Replications Week, online. <https://forrt.org/LoveReplicationsWeek/>

-   **Röseler, L.** (2026, January). Open Science Professional at the Center for Emerging Researchers, online.
...
-   Q&A for Center for Open Science's Blog: "Building a Publishing Model for Replication: Q&A with the Senior Editors of Replication Research". <https://www.cos.io/blog/building-a-publishing-model-for-replication-qa-with-the-senior-editors-of-replication-research>
...
-   Interview for Public Marketing on "Why Open Science?", <https://www.publicmarketing.eu/_rubric/detail.php?rubric=Kultur-Bildung&nr=62970>. Unpaywalled version and English translation available at [https://doi.org/10.5281/zenodo.15772307](#0).
...
DT::datatable(researchtable                
              , selection = "none"                
              , rownames = FALSE                
              , options = list(pageLength = 40, dom = "tip", bPaginate = FALSE)               #, filter = "top"               
              ) 
```
